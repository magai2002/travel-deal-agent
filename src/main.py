...
def _record_if_deal(route: Route, mode: str, depart_date, price_eur: float, url: str | None, found_deals: list[dict]) -> None:
    ...
    for route in cfg.routes:
        ...
        for depart_date, return_date in dates:
            ...
            if result:
                ...
                _record_if_deal(route, "flixbus", depart_date, result.price_eur, result.booking_url, found_deals)
            else:
